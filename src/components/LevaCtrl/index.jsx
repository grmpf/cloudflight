		...
		//'Font': folder({
			...
			fontFamily: {
				...
				options: { //https://google-webfonts-helper.herokuapp.com/api/fonts/raleway
					...
					//'work in progress2': 'https://fonts.gstatic.com/s/inter/v7/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMw2boKoduKmMEVuBWYAZ9hjg.woff',
					//'Ubuntu 700 (mono)': 'https://fonts.gstatic.com/s/ubuntumono/v10/KFO-CneDtsqEr0keqCMhbC-BL9H1tYs.woff',
